...
export const PROJECTS: Project[] = [
  ...
  },
  {
    ...
    title: "Ethio-Agri",
    description:
      "An Ethiopian agriculture-focused intelligent platform designed to help farmers identify agricultural diseases and access useful agricultural information.",
    ...
    technologies: ["Python", "Machine Learning", "Next.js", "React", "PostgreSQL", "TensorFlow"],
    features: [
...
export const GITHUB_FALLBACK_REPOS: GithubRepo[] = [
  ...
  {
    name: "mesob-gebeya",
    description: "Full-stack Ethiopian e-commerce platform built with Next.js and PostgreSQL.",
    language: "TypeScript",
    stars: 0,
    forks: 0,
    url: "https://github.com/gebryeamare",
  ...
  {
    name: "ethio-agri",
    description: "Agriculture-focused intelligent platform for crop disease detection.",
    language: "Python",
    stars: 0,
    forks: 0,
    url: "https://github.com/gebryeamare",
